...
for i in range(1, 6):
    ...
    if i == 1:
        Tdist = 1
        inputcond = 1
        titlestring = 'Uniform T-dist. Somatic input'
    if i == 2:
        Tdist = 1
        inputcond = 3      
        titlestring = 'Na blocked. Somatic input'
    if i == 3:
        Tdist = 1
        inputcond = 2
        titlestring = 'Uniform T-dist. Synaptic input'
    if i == 4:
        Tdist = 2
        inputcond = 1
        titlestring = 'Linear T-dist. Somatic input'
    if i == 5:
        Tdist = 2
        inputcond = 2
        titlestring = 'Linear T-dist. Synaptic input'
    

    vec = test(Tdist, inputcond)
